...
public interface Opus extends Library {
	public static final Opus INSTANCE = Native.loadLibrary(OpusLibraryPathLoader.getPath(), Opus.class);
	...
	int opus_encode_float(PointerByReference st, FloatByReference pcm, int frame_size, Pointer data,
			int max_data_bytes);
	...
	int opus_multistream_decode_float(PointerByReference st, Pointer data, int len, FloatByReference pcm,
